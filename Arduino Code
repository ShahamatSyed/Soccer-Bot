...
else if(t == 'X'){      //turn right (left side motors rotate in forward direction,  right side motors doesn't rotate)
  digitalWrite(4,LOW); 
  digitalWrite(5,HIGH);
...
else  if(t == 'Y'){      //turn left (right side motors rotate in forward direction, left  side motors doesn't rotate)
  digitalWrite(4,HIGH); // If the left motor is spinning opposite direction shuffle the HIGH and LOW
  digitalWrite(5,LOW);
